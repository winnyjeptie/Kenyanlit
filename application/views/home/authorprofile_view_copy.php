...
<!-- Multiple Checkboxes -->
          ...
          <div class="form-group">
            <label class="col-md-4 control-label" for="upload_pdf">Upload pdf excerpt </label> 
            <div class="col-md-4">
           <input id="Upload photo" name="file_name" class="input-file" type="file" required="required">
           </div>
