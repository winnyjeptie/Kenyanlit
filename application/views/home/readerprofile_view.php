...
<!-- Navigation -->
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-10 ">
        <form class="form-horizontal" method ="POST" action="<?=site_url('home/upload_pic')?>" accept-charset="utf-8" enctype="multipart/form-data">
          <fieldset>
...
<!-- Multiple Checkboxes -->
          ...
          <input type="hidden" class = "form-control" name="reader_email" id="reader_email"  placeholder="" value = "<?php echo $email;?>" >
         ...
         <div class="form-group">
           ...
           <div class="col-md-4">
             <input id="Upload_photo" name="file_name" class="input-file" type="file">
           </div>
         </div>
...
<!-- File Button --> 
<!-- <div class="form-group">
  <label class="col-md-4 control-label" for="Upload_pdf">Upload sample excerpt</label>
  <div class="col-md-4">
    <input id="Upload photo" name="Upload_pdf" class="input-file" type="file" required="required">
  </div>
</div> -->
...
<!-- <div class="form-group">
  ...
  <div class="col-md-4">
    <input id="Upload photo" name="file_name" class="input-file" type="file">
  </div>
</div> -->
