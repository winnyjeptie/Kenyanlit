...
<body style="background-image: url(grayscale/img/books2.jpg)"; id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!-- Intro Header -->
    <header style="background-image: url(grayscale/img/books2.jpg)"; class="intro">
